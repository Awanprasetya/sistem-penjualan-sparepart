...
<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Atur Jadwal Shift Karyawan</h1>
          </div>
          <ol class="breadcrumb" >
            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard' ?>"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;Dashboard</a></li>
            <li class="breadcrumb-item active"><a href="#">Atur Jadwal Shift Karyawan</a></li>
          </ol>
          <?php
            ...
            <div class="col-lg-10 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-9">
                  <h6 class="m-0 font-weight-bold text-primary">Jadwal Shift Karyawan</h6>
                </div>
                <div class="card-body">
                ...
                <table id="example" class="table table-bordered Datatables">
                    ...
                    <tbody>
                      <?php 
                      $no = 1;
                      foreach($get_shift_karyawan as $n ){
                        ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?= $n->no_finger;?></td>
                            ...
                            <td>
                              ...
                              <button class="btn btn-danger btn-sm" onclick="deleteShiftKaryawan('<?php echo $n->id_karyawan_shift; ?>')">Hapus</button>                            
...
<script>
function deleteShiftKaryawan(id_karyawan_shift) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = "<?php echo base_url('c_shift/delete/'); ?>" + id_karyawan_shift;
        }
    })
}
</script>
