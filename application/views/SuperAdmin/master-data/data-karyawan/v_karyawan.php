...
<div class="container-fluid">
  ...
  <div class="row mb-3">
    <div class="col">
      ...
      <a class="btn btn-outline-warning" href="<?php echo base_url().'c_karyawan/export_excel'?>"><i class="fa fa-print"></i>&nbsp;Export To Excel</a>
    </div>
  </div>
          ...
          <div class="table-responsive">
            <table id="example" class="table table-bordered Datatables">
              ...
              <tbody>
                <?php 
                $no = 1;
                foreach($get_karyawan as $n ){
                ?>
                <tr style="font-size:x-small;">
                  <td><?= $no++; ?></td>
                  <td><?= $n->no_finger;?></td>
                  <td><?= $n->nik; ?></td>
                  <td><a href="<?php echo base_url().'c_karyawan/v_detail/'.$n->no_finger?>" style="color:white;"><?= $n->nm_karyawan; ?></a></td>
                  
                  <td>
                    <!-- <a class="btn btn-primary btn-sm" href="<?php echo base_url().'c_karyawan/v_detail/'.$n->no_finger?>" style="color:white;"><i class="fa fa-user"></i>&nbsp;Detail</a> -->
                    <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal<?= $n->no_finger?>" style="color:white;"><i class="fa fa-edit"></i>&nbsp;Edit</a>
                    <button class="btn btn-danger btn-sm" onclick="deleteKaryawan('<?php echo $n->no_finger; ?>')">Hapus</button>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
