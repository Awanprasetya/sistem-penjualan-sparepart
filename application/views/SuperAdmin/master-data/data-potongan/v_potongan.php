...
<div class="container-fluid">
          ...
          <ol class="breadcrumb" >
            ...
            <li class="breadcrumb-item active"><a href="#">Data Potongan</a></li>
          </ol>
          <?php
              ...
              <div class="card shadow mb-4">
                ...
                <table id="example" class="table table-bordered Datatables">
                    ...
                    <tbody>
                      <?php 
                      $no = 1;
                      foreach($get_potongan as $n ){
                        ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?= $n->nama_potongan;?></td>
                            <td><?= number_format($n->jumlah,1); ?></td>
                            <td>
                            
                             
                              <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal<?= $n->id_potongan?>" style="color:white;"><i class="fa fa-edit" ></i>&nbsp;Edit</a>
                              <button class="btn btn-danger btn-sm" onclick="deletePotongan('<?php echo $n->id_potongan; ?>')">Hapus</button>                            
...
<script>
function deletePotongan(id_potongan) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = "<?php echo base_url('c_potongan/delete/'); ?>" + id_potongan;
        }
    })
}
</script>