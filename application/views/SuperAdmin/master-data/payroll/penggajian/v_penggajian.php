...
<div class="container-fluid">
          ...
          <ol class="breadcrumb" >
            ...
            <li class="breadcrumb-item active"><a href="#">Data Penggajian</a></li>
          </ol>
          <?php
          ...
          <?php echo $this->session->flashdata('success');?>
            <div class="row mb-3">
                <div class="col">
                    ...
                    <a class="btn btn-outline-warning" href="<?php echo base_url().'c_payroll/export_excel/'.$startDate.'/'.$endDate?>"><i class="fa fa-print"></i>&nbsp;Export To Excel</a> 
                </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="row mb-3">
                  <div class="col-lg-6">
                  <form id="filterForm" method="GET" action="<?php echo base_url('c_payroll/v_penggajian'); ?>">
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            ...
                            <button class="btn btn-outline-success" type="button" id="saveBtn">Save</button>
                        </div>
                    </div>
                </form>
    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td style="font-size: 12px;"><?=$n->norek;?></td>
...
<script>
    // Fungsi ketika tombol Save ditekan
    document.getElementById('saveBtn').addEventListener('click', function() {
        var startDate = document.getElementById('startDate').value;
        var endDate = document.getElementById('endDate').value;

        // Kondisi jika input tanggal sudah dipilih
        if (startDate && endDate) {
            window.location.href = '<?php echo base_url('c_payroll/save_payroll'); ?>?start_date=' + startDate + '&end_date=' + endDate;
        } else {
