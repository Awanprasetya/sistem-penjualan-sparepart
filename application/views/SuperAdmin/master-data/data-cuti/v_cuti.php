...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a href="#">Data Cuti</a></li>
  </ol>
  ...
  <div class="row mb-3">
    <div class="col">
      ...
      <a class="btn btn-outline-warning" href="<?php echo base_url().'c_cuti/cuti_export_excel'?>"><i class="fa fa-print"></i>&nbsp;Export To Excel</a>
    </div>
  </div>
