  ...
  <div class="row justify-content-center text-center">
    ...
    <div class="col-xl-2 col-md-4 col-sm-6 mb-1">
      <div class="card shadow h-100 py-3 card-hover" style="background: linear-gradient(45deg, #36d1dc, #5b86e5);">
        <a href="<?php echo base_url().'c_cuti/v_cuti'; ?>" class="text-decoration-none text-white">
          <div class="card-body">
            <i class="fa fa-table fa-2x mb-2"></i>
            <h6 class="font-weight-bold">Data Cuti</h6>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6 mb-1">
      <div class="card shadow h-100 py-3 card-hover" style="background: linear-gradient(45deg, #11998e, #38ef7d);">
        <a href="<?php echo base_url().'c_cuti/v_sisa_cuti'; ?>" class="text-decoration-none text-white">
          <div class="card-body">
            <i class="fas fa-tasks fa-2x mb-2"></i>
            <h6 class="font-weight-bold">Sisa Cuti </h6>
          </div>
        </a>
      </div>
    </div>
