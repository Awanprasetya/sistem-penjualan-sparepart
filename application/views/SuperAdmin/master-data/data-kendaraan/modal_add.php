...
<div class="modal" id="addModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- <?php echo form_open_multipart('c_kendaraan/insertKendaraan')?> -->
      <form class="form-horizontal form-bordered" name="autoSumForm" autocomplete="off" action="<?php echo base_url().'c_kendaraan/insertKendaraan/' ?>" method="post">
      ...
      <div class="input-group-prepend">
        ...
        <input type="num" name="harga" id="harga" class="form-control " aria-hidden="true" required>
      </div>
      </div>
      </div>
