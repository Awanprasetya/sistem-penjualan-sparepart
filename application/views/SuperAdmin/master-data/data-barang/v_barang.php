...
<div class="container-fluid">
  ...
  <div class="row mb-3">
    <div class="col">
      ...
      <a class="btn btn-outline-warning" href="<?php echo base_url().'c_barang/export_excel'?>"><i class="fa fa-print"></i>&nbsp;Export To Excel</a>
    </div>
  </div>
              ...
              <tbody>
                ...
                <tr style="font-size:small;">
                  ...
                  <td>
                    ...
                    <button class="btn btn-danger btn-sm" onclick="deleteBarang('<?php echo $n->kd_barang; ?>')">Hapus</button>
                  </td>
...
<script>
function deleteBarang(kd_barang) {
    Swal.fire({
