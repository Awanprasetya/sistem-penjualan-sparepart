            ...
            <div class="col-lg-10 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-9">
                  <h6 class="m-0 font-weight-bold text-primary">Rincian Payroll </h6>
                </div>
                <div class="card-body">
                      ...
                      foreach($get_jbt as $n ){
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal<?= $n->id_jbt?>" style="color:white;"><i class="fa fa-edit" ></i>&nbsp;Edit</a>
                              <button class="btn btn-danger btn-sm" onclick="deleteJabatan('<?php echo $n->id_jbt; ?>')">Hapus</button>                            
