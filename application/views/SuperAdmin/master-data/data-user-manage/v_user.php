...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a href="#">User Setting</a></li>
  </ol>
              ...
              <tbody>
                ...
                <tr style="font-size:small;">
                  ...
                  <td>
                    ...
                    <button class="btn btn-danger btn-sm" onclick="deleteUser('<?php echo $n->id; ?>')">Hapus</button>
                  </td>
...
function deleteUser(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = "<?php echo base_url('c_user_manage/delete/'); ?>" + id;
        }
    });
}
</script>
