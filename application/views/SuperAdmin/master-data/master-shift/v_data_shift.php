...
<div class="container-fluid">
          ...
          <ol class="breadcrumb" >
            ...
            <li class="breadcrumb-item active"><a href="#">Data Shift</a></li>
          </ol>
          <?php
                      ...
                      foreach($get_shift as $n ){
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal<?= $n->id_shift?>" style="color:white;"><i class="fa fa-edit" ></i>&nbsp;Edit</a>
                              <button class="btn btn-danger btn-sm" onclick="deleteShift('<?php echo $n->id_shift; ?>')">Hapus</button>                            
...
function deleteShift(id_shift) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = "<?php echo base_url('c_master_shift/delete/'); ?>" + id_shift;
        }
    })
}
</script>
